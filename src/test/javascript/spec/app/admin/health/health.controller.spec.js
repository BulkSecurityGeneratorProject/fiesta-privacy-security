...
describe('Controller Tests', function () {
    ...
    describe('JbtHealthCheckController', function () {
        var $scope, jbtHealthService; // actual implementations
        var createController; // local utility functions

        beforeEach(inject(function ($injector, JbtHealthService) {
            $scope = $injector.get('$rootScope').$new();
            jbtHealthService = JbtHealthService;
            var locals = {
                '$scope': $scope
            };
            createController = function() {
                $injector.get('$controller')('JbtHealthCheckController as vm', locals);
            };
            createController();
        }));
