(function() {
    ...
    jbtAlertErrorController.$inject = ['$scope', 'AlertService', '$rootScope'];

    function jbtAlertErrorController ($scope, AlertService, $rootScope) {
        var vm = this;
        ...
        var cleanHttpErrorListener = $rootScope.$on('fiestaSecurityUiApp.httpError', function (event, httpResponse) {
            var i;
