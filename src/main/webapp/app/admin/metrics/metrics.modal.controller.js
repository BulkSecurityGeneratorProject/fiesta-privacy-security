(function() {
    ...
    angular
        ...
        .controller('JbtMetricsMonitoringModalController', JbtMetricsMonitoringModalController);

    JbtMetricsMonitoringModalController.$inject = ['$uibModalInstance', 'threadDump'];

    function JbtMetricsMonitoringModalController ($uibModalInstance, threadDump) {
        var vm = this;
